...
return [
    ...
    'exchange_rate' => __('global.exchange_rate'),
    'format' => __('global.format'),
    'decimal_point' => __('global.decimal_point'),
    'thousand_point' => __('global.thousand_point'),
    'enabled.label' => __('global.enabled'),
    ...
    'vendor_bio.label' => 'Vendor Bio',
    'deliver_up_to_max_miles.label' => 'Deliver up to Max Miles',
    'express_delivery_rate.label' => 'Express Delivery Rate',
    'standard_delivery_rate.label' => 'Standard Delivery Rate',
    'submit.label' => 'Save',
