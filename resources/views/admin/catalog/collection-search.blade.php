<div x-data>
    <x-admin.components.button wire:loading wire:click.prevent="$set('showBrowser', true)" type="button"
        @click="$dispatch('showslideover')">
                ...
                <div wire:loading.class="hidden" wire:target="searchTerm">
                    ...
                    <div class="mt-4 space-y-1">
                        @forelse($this->results as $collection)
                            <div
                                class="flex w-full items-center justify-between rounded shadow-sm text-left border px-2 py-2 text-sm @if ($this->existingIds->contains($collection->id)) opacity-25 @endif">
                                <div class="truncate">
                                    ...
                                    <span
                                        class="block pr-32 text-xs text-gray-400 truncate">{{ $collection->breadcrumb }}</span>
                                </div>
