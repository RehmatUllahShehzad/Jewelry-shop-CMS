...
trait EditableTrait
{
    ...
    public function setPlaceholder($placeholder, $content): self
    {
    ...
    private function replacePlaceholders()
    {
        ...
        foreach ($this->getPlaceholders() as $placeholder => $replaceContent) {
            $processedContent = str_replace($placeholder, $replaceContent, $processedContent);
        }
